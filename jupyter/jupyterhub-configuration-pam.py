...
#  .. deprecated: 0.9
#      Use JupyterHub.bind_url
c.JupyterHub.ip = '192.168.100.221'
...
#The following configuration entries are added by rxie to enable LDAP authentication in the JupyterHub 
...
#c.LDAPAuthenticator.server_address = 'nydc-dc01.novantas.pri'
#c.LDAPAuthenticator.bind_dn_template = 'CN={username},OU=Novantas Users,dc=novantas,dc=pri'
#c.LDAPAuthenticator.lookup_dn_user_dn_attribute = 'CN'
#c.LDAPAuthenticator.lookup_dn = True
#c.LDAPAuthenticator.use_ssl = True
#c.LDAPAuthenticator.lookup_dn_search_filter = '({login_attr}={login})'
#c.LDAPAuthenticator.lookup_dn_search_user = 'CN=ldapbind2,OU=Novantas Users (System),DC=novantas,DC=pri'
#c.LDAPAuthenticator.lookup_dn_search_password = 'B0urD@1n!R35rV@tI0n'
#c.LDAPAuthenticator.user_attribute = 'sAMAccountName'
#c.LDAPAuthenticator.user_search_base = 'ou=Novantas Users,dc=novantas,dc=pri'
...
#The following udf is to enable Kerberos ticket be auto granted by using a customized 
#shell script to issue ticket after user is authenticated and before a kernel is spawned
from subprocess import check_call
import os
